...
class Drawing:
    ...
    def win(self):
        render = self.font_win.render('ТИ ВИГРАВ!', 1, (randrange(40, 120), 0, 0))
    ...
    def menu(self):
        ...
        start = button_font.render('ПУСК', 1, pygame.Color('lightgray'))
        button_start = pygame.Rect(0, 0, 400, 150)
        button_start.center = HALF_WIDTH, HALF_HEIGHT
        exit = button_font.render('ВИХІД', 1, pygame.Color('lightgray'))
        ...
        while self.menu_trigger:
            ...
            self.sc.blit(start, (button_start.centerx - 120, button_start.centery - 70))

            pygame.draw.rect(self.sc, BLACK, button_exit, border_radius=25, width=10)
            self.sc.blit(exit, (button_exit.centerx - 120, button_exit.centery - 70))

            color = randrange(40)
            label = label_font.render('ORIGIN', 1, (color, color, color))
