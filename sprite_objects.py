...
class Sprites:
    def __init__(self):
        ...
        self.list_of_objects = [
            SpriteObject(self.sprite_parameters['sprite_flame'], (7.1, 2.1)),
            SpriteObject(self.sprite_parameters['sprite_barrel'], (5.9, 2.1)),
            SpriteObject(self.sprite_parameters['sprite_barrel'], (4.7, 2.5)),
            SpriteObject(self.sprite_parameters['npc_devil'], (7, 4)),
            SpriteObject(self.sprite_parameters['sprite_flame'], (7.6, 5.6)),
            ...
            SpriteObject(self.sprite_parameters['sprite_flame'], (3.51, 1.5)),
            SpriteObject(self.sprite_parameters['sprite_barrel'], (6.9, 2.92)),
            SpriteObject(self.sprite_parameters['sprite_flame'], (7.8, 1.47)),
            SpriteObject(self.sprite_parameters['sprite_flame'], (6.5, 20.1)),
            SpriteObject(self.sprite_parameters['npc_soldier0'], (9.9, 21.9)),
            SpriteObject(self.sprite_parameters['sprite_barrel'], (4.8, 5.8)),
            SpriteObject(self.sprite_parameters['npc_soldier0'], (8.29, 6.7)),
            SpriteObject(self.sprite_parameters['npc_devil'], (26, 7)),
            SpriteObject(self.sprite_parameters['sprite_flame'], (12, 9)),
            SpriteObject(self.sprite_parameters['npc_devil'], (22, 13)),
            SpriteObject(self.sprite_parameters['sprite_flame'], (13, 8)),
            SpriteObject(self.sprite_parameters['npc_devil'], (26, 8)),
            SpriteObject(self.sprite_parameters['npc_devil'], (26, 9)),
            SpriteObject(self.sprite_parameters['npc_soldier0'], (10.29, 4.5)),
            SpriteObject(self.sprite_parameters['sprite_flame'], (11.29, 3.5)),
            SpriteObject(self.sprite_parameters['npc_soldier0'], (12.29, 2.8)),
            SpriteObject(self.sprite_parameters['sprite_flame'], (3.29, 6.7)),
            SpriteObject(self.sprite_parameters['npc_soldier0'], (12.26, 6.5)),
            SpriteObject(self.sprite_parameters['npc_soldier0'], (11.29, 5.5)),
            SpriteObject(self.sprite_parameters['sprite_flame'], (12.29, 5.8)),
            SpriteObject(self.sprite_parameters['npc_soldier0'], (13.61, 6.7)),
            SpriteObject(self.sprite_parameters['sprite_barrel'], (9.9, 5.5)),
            SpriteObject(self.sprite_parameters['npc_soldier0'], (5.29, 6.5)),
            SpriteObject(self.sprite_parameters['sprite_flame'], (7.29, 5.1)),
            SpriteObject(self.sprite_parameters['npc_soldier0'], (8.29, 5.9)),
            SpriteObject(self.sprite_parameters['npc_soldier0'], (7.20, 6.4)),
            SpriteObject(self.sprite_parameters['sprite_flame'], (3.29, 8.9)),
            SpriteObject(self.sprite_parameters['sprite_flame'], (4.29, 5.2)),
            SpriteObject(self.sprite_parameters['sprite_flame'], (2.29, 5.9)),
            SpriteObject(self.sprite_parameters['npc_soldier0'], (12.29, 5.9)),
            SpriteObject(self.sprite_parameters['sprite_flame'], (110.29, 6.4)),
            SpriteObject(self.sprite_parameters['npc_devil'], (17.29, 7.2)),
            SpriteObject(self.sprite_parameters['npc_soldier0'], (13.29, 3.9)),
            SpriteObject(self.sprite_parameters['npc_soldier0'], (14.29, 5.9)),
            SpriteObject(self.sprite_parameters['npc_soldier0'], (20.29, 6.9)),
